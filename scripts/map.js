...
var map = L.mapbox.map('map', "toddfhughes.0j7569n4").setView([53.427025, -7.941634],
	10);
...
function getLayer(callback, cloudantView) {
	var cloudantURLbase =
		"https://garuda3060.cloudant.com/eire/_design/tour/_view/";
...
function searchPoints(callback, cloudantSearch) {
	var cloudantURLbase =
		"https://garuda3060.cloudant.com/eire/_design/tour/_search/ids?q=";
	var cloudantURLcallback = "&callback=?";
...
function getPoints(cloudantIDs) {
	...
	function getPoint(id) {
		var cloudantURLbase = "https://garuda3060.cloudant.com/eire/";
